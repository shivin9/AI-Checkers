...
def save_Network(network):
    ...
    """
    np.save('./parameters/VIH_nok', network[0])
    np.save('./parameters/VHO_nok', network[1])
    np.save('./parameters/EIH_nok', network[2])
    np.save('./parameters/EHO_nok', network[3])
...
def main():
    ...
    #network = board.train(episodes=5000)
    #save_Network(network)
